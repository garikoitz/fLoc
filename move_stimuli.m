basedir='/Users/tiger/Desktop/stimuli';
lang={'ES','EU','JP'};
...
for lan = 1: length(lang)
    for sti = 1:length(stim)
        ...
        % Define folder paths
        folder1 = [basedir '/' cat '1']; % Change to your actual path
        folder2 =  [basedir '/' cat '2']; % Change to your actual path
        destinationFolder =  [basedir '/' cat]; % Change to your actual destination path
