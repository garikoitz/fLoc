classdef votclocSequence_seprun
    ...
    properties (Constant, Hidden)
        ...
        % CN
        stim_set1 = {'body' 'CN_word1' 'adult' 'CN_FF' 'ES_CB'};
        stim_set2 = {'limb' 'CN_word2' 'child' 'CN_CS' 'CN_SC'};
    ...
    methods
        ...
        % class constructor
        function seq = votclocSequence_seprun(stim_set, num_runs, task_num)
            if nargin < 1
                seq.stim_set = 3;
            else
