function [el, dummymode, edfFile]=init_eyelink(session,run_num,window,rect,screenNumber)
    ...
    % for old imac, it is 1280x1024, and the proportion is 0.715 0.715
    % for the new mac, it is 1980x1080, the proportion is 0.477 0.678
    Eyelink('Command','calibration_area_proportion = 0.477 0.678')
